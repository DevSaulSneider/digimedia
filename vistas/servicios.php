...
<head>
    ...
    <link rel="stylesheet" href="<?=URL?>src/style/servicios.css">
    ...
    <p class="fs-1 d-none d-lg-block">El marketing digital en 3 pasos</p>
      <div class="row mt-5">
        <div class="col-md-6 col-lg-4 text-center px-0">
          ...
          <img src="<?=URL?>src/images/servicios/carnet-de-identidad.webp" alt="" class="100%" width="121px" height="121px">
        ...
        <div class="col-md-6 col-lg-4 px-0">
          ...
          <img src="<?=URL?>src/images/servicios/diana.webp" alt="" width="122px" height="121px">
          <div class="container w-75 mt-3"  style="background-color: #EFEFEF;">
        ...
        <div class="col-lg-4 text-center px-0 ">
          ...
          <img src="<?=URL?>src/images/servicios/chat.webp" alt="" width="135px" height="134px">
          <div class="container w-75 mt-3" style="background-color: #EFEFEF;">
    ...
    <div class="container text-center w-75 mt-5">
      <div class="row" >
        <div class="col-6 col-lg-3" style="width:220px">
            <a href="<?= URL ?>marca">
            <img src="<?=URL?>src/images/servicios/CrearmiMarca.webp" alt="" class="w-100  pt-3 " width="100%" height="100%">
            </a>
        </div>
        <div class="col-6 col-lg-3" style="width:220px">
            <a href="<?= URL ?>marketing">
            <img src="<?=URL?>src/images/servicios/MarketingDigital.webp" alt=""  class="w-100  pt-3" width="100%" height="100%">
            </a>
        </div>
        <div class="col-6 col-lg-3" style="width:220px">
            <a href="<?= URL ?>diseno">
            <img src="<?=URL?>src/images/servicios/DiseñoGrafico.webp" alt=""  class="w-100 pt-3" width="100%" height="100%">
            </a>
        </div>
        <div class="col-6 col-lg-3" style="width:220px">
            <a href="<?= URL ?>web">
            <img src="<?=URL?>src/images/servicios/Diseñoweb.webp" alt=""   class="w-100  pt-3" width="100%" height="100%">
            </a>
        </div>
      </div>
    </div>
