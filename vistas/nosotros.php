        ...
        <div class="container back-img px-0"
            ...
            <div class="row m-0 p-4 mx-0 w-100">
                <div class="col-lg-6 pt-lg-2">
                    <p class="fs-5 w-75 text-center">¿<b>Qué puedes lograr</b> con una buena estrategia de marketing
                        digital?</p>
                </div>
        ...
        <div class="container-xl sm-w100 md-w75">
            <div class="row">
                <div class="col-12 col-lg-6 px-0 mx-0 img-esquema1"> <img
                        src="<?=URL?>src/images/nosotros/esquema1.webp" alt="" class="w-100 h-100"> </div>
                <div class="col-12 col-lg-6 px-0 mx-0 img-esquema2"> <img
                        src="<?=URL?>src/images/nosotros/esquema2.webp" alt="" class="w-100 h-100"> </div>
                <div class="col-12 col-lg-6 px-0 mx-0 img-esquema2m"> <img
                        src="<?=URL?>src/images/nosotros/esquema2M.jpg" alt="" class="w-100 h-100"> </div>
            </div>
        </div>
