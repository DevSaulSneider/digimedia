...
<head> <?php require "vistas/layouts/header.php" ?> <title>Cont&aacute;ctanos | Agencia de Marketing Digital para PYMES |
...
<body> <?php require "vistas/layouts/navbar.php" ?> <section class="w-100">
